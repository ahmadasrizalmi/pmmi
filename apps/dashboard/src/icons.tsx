...
export type IconName =
  | 'home' | 'users' | 'clipboard' | 'book' | 'award' | 'bot' | 'settings'
  | 'menu' | 'chevron-left' | 'chevron-right' | 'sun' | 'moon' | 'logout'
  | 'bell' | 'key' | 'link' | 'shield' | 'database' | 'refresh' | 'copy'
  | 'check' | 'x' | 'search' | 'user' | 'folder' | 'wallet';
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  key: <><circle cx="7.5" cy="15.5" r="4.5"/><path d="m10.8 12.2 8-8M16 7l2 2M13.5 9.5l2 2"/></>,
  link: <><path d="M10 13a5 5 0 0 0 7.07.07l2-2A5 5 0 0 0 12 4"/><path d="M14 11a5 5 0 0 0-7.07-.07l-2 2A5 5 0 0 0 12 20"/></>,
  ...
  wallet: <><path d="M4 6h15a2 2 0 0 1 2 2v10H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12"/><path d="M16 11h5v4h-5a2 2 0 0 1 0-4Z"/></>,
};
