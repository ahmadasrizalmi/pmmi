...
| 2 | TLS 3 domain + redirect http→https; vhost | ✅ | `docs/evidence/G1.md`: tunnel `pmmi-home-server` + cloudflared service → `https://` 3 domain **200**, `http→https 301` (edge `always_use_https`); ingress pondok→8080, app→8081, ai→3001 |
